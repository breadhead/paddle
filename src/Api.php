...
class Api {
	...
	public function generate_product_pay_link($product_id, array $optional_arguments = array()) {
		$data = array();
		$data['product_id'] = Breadhead\Paddle\Filters::filter_product_id($product_id);
		if (isset($optional_arguments['title'])) {
			$data['title'] = Breadhead\Paddle\Filters::filter_title($optional_arguments['title']);
		}
		if (isset($optional_arguments['image_url'])) {
			$data['image_url'] = Breadhead\Paddle\Filters::filter_image_url($optional_arguments['image_url']);
		}
		if (isset($optional_arguments['price'])) {
			$data['price'] = Breadhead\Paddle\Filters::filter_price($optional_arguments['price']);
		}
		if (isset($optional_arguments['return_url'])) {
			$data['return_url'] = Breadhead\Paddle\Filters::filter_return_url($optional_arguments['return_url']);
		}
		if (isset($optional_arguments['discountable'])) {
			$data['discountable'] = Breadhead\Paddle\Filters::filter_discountable($optional_arguments['discountable']);
		}
		if (isset($optional_arguments['coupon_code'])) {
			$data['discountable'] = 1;
		}
		if (isset($optional_arguments['locker_visible'])) {
			$data['locker_visible'] = Breadhead\Paddle\Filters::filter_locker_visible($optional_arguments['locker_visible']);
		}
		if (isset($optional_arguments['quantity_variable'])) {
			$data['quantity_variable'] = Breadhead\Paddle\Filters::filter_quantity_variable($optional_arguments['quantity_variable']);
		}
		if (isset($optional_arguments['paypal_cancel_url'])) {
			$data['paypal_cancel_url'] = Breadhead\Paddle\Filters::filter_paypal_cancel_url($optional_arguments['paypal_cancel_url']);
		}
		if (isset($optional_arguments['expires'])) {
			$data['expires'] = Breadhead\Paddle\Filters::filter_expires($optional_arguments['expires']);
		}
		if (isset($optional_arguments['is_popup'])) {
			$data['is_popup'] = Breadhead\Paddle\Filters::filter_is_popup($optional_arguments['is_popup']);
		}
		if (isset($optional_arguments['parent_url'])) {
			$data['parent_url'] = Breadhead\Paddle\Filters::filter_parent_url($optional_arguments['parent_url']);
		}
		if (isset($optional_arguments['affiliates'])) {
			$data['affiliates'] = Breadhead\Paddle\Filters::filter_affiliates($optional_arguments['affiliates']);
		}
		if (isset($optional_arguments['stylesheets'])) {
			$data['stylesheets'] = Breadhead\Paddle\Filters::filter_stylesheets($optional_arguments['stylesheets']);
		}
	...
	public function generate_custom_product_pay_link($title, $price, $image_url, $webhook_url, array $optional_arguments) {
	    $data = array();
		$data['title'] = Breadhead\Paddle\Filters::filter_title($title);
		$data['price'] = Breadhead\Paddle\Filters::filter_price($price);
		$data['image_url'] = Breadhead\Paddle\Filters::filter_image_url($image_url);
		$data['webhook_url'] = Breadhead\Paddle\Filters::filter_webhook_url($webhook_url);
		if (isset($optional_arguments['return_url'])) {
			$data['return_url'] = Breadhead\Paddle\Filters::filter_return_url($optional_arguments['return_url']);
		}
		if (isset($optional_arguments['locker_visible'])) {
	...
	public function get_products($limit = 1, $offset = 0) {
		$data = array();
		$data['limit'] = Breadhead\Paddle\Filters::filter_limit($limit);
		$data['offset'] = Breadhead\Paddle\Filters::filter_offset($offset);
	...
	public function generate_orders_report($product_id = null, $start_timestamp = null, $end_timestamp = null) {
		...
		if (isset($start_timestamp)) {
			$data['from_date'] = Breadhead\Paddle\Filters::filter_start_timestamp($start_timestamp);
		}
		if (isset($end_timestamp)) {
			$data['to_date'] = Breadhead\Paddle\Filters::filter_end_timestamp($end_timestamp);
		}
	...
	public function generate_auth_code($vendor_email, $vendor_password) {
		$data = array();
		$data['email'] = Breadhead\Paddle\Filters::filter_email($vendor_email);
	...
	public function register_external_application($application_name, $application_description, $application_icon_url) {
		...
		$data['icon'] = Breadhead\Paddle\Filters::filter_application_icon_url($application_icon_url);
