...
class GenerateCustomProductPayLink extends Test_Case {
	...
	public function test_valid_arguments() {
		...
		$url = $this->api->generateCustomProductPayLink($this->title, $this->price, $this->image_url, $this->webhook_url, $data);
